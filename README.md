...
2023 SK플래닛 ASAC 기업 프로젝트 '1조 18층에 사람있어요'는 NLP기반의 데이터로 사용자가 원하는 정보의 링크를 추천해주는 추천 시스템 개발을 하였다. 

NLP 기반의 데이터를 허깅페이스 모델을 사용히여 링크를 추천해준다.
...
### 0. 문제 정의 및 목표
 ...
 기존 추천 시스템은 데이터가 부족한 문제점이 있어 사용자가 원하는 정보를 추천해주지 못하였다. 데이터가 부족한 문제점을 해결하기 위한 방법을 제시하고, 모델을 개선하여 사용자가 원하는 추천 정보 시스템을 개발하는 것이 본 프로젝트의 목표이다.
